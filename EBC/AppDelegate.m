...
- (void)saveContext
{
    ...
    if (managedObjectContext1 != nil) {
        if ([managedObjectContext1 hasChanges] && ![self.managedObjectContext save:&error]) {
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Entity.sqlite"];
